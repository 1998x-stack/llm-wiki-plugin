...
- [[STRIPS 规划器]] — STR[[逆倾向评分|IPS]]（STanford Research Institute Problem Solver）是人工智能历史上最具影响力的自动规划系统 (confidence: 1.0)
...
- [[端到端视觉运动学习]] — 端到端视觉运动学习是让机器人直接从原始摄像头像素映射到关节力矩的深度学习范式，绕过传统的感知-状态估计-规划-控制模块化流水线，用统一的神经网络[[联合训练|联 (confidence: 0.92)
