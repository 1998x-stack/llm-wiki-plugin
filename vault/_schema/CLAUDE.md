...
- `机器人学` — 运动规划、机器人控制、感知定位（60 页）
- `信息论` — Shannon 信息论、编码理论、压缩理论（50 页）
- `概率论` — 概率公理、随机过程、统计推断（41 页）
- `矩阵理论` — 线性代数、特征值理论、数值线性代数（31 页）
- `经济学` — 宏观经济学、凯恩斯主义、增长理论（26 页）
- `AI工程` — LLM 上下文工程、RAG、Agent 基础设施（24 页）
- `Agent系统` — AI Agent 架构、工作流、评估方法论（24 页）
- `工具与框架` — 开发工具、运行时、Claude 模型系列（23 页）
- `文档处理` — PDF 解析、OCR、文档结构提取（21 页）
- `深度学习` — Transformer、注意力机制、归一化技术（16 页）
- `数学` — 纯数学：组合、分析、计算理论（11 页）
- `LLM能力` — 上下文压缩、扩展思维、提示词缓存（10 页）
- `AI设计` — AI 辅助 UI/UX 设计、设计规则系统（9 页）
- `其他` — 小型 cluster 合并（4 页）
