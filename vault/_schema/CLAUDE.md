...
- `AI工程` — AI 工程、Agent 工具、LLM 开发实践（706 页）
- `推荐系统` — 推荐算法、协同过滤、工业应用（270 页）
- `社会科学` — 社会学、社会理论、政治经济（220 页）
- `机器学习` — 传统与现代机器学习方法（205 页）
- `计算理论` — 计算理论、分布式系统、密码学（142 页）
- `经济学` — 经济学、金融与市场（120 页）
- `工具与框架` — 开发工具、框架与生态（110 页）
- `游戏开发` — 游戏引擎、渲染、动画（108 页）
- `Agent系统` — Agent 架构、编排与技能系统（101 页）
- `信息论` — 信息熵、编码理论与通信（71 页）
- `概率论` — 概率论、统计学、贝叶斯（70 页）
- `数值分析` — 数值方法、优化与计算数学（65 页）
- `脑科学` — 认知科学、神经科学、心理学（65 页）
- `机器人学` — 机器人学、运动规划、控制（59 页）
- `天文学` — 天体物理、宇宙学、科学史（55 页）
- `时间序列` — 时序分析、序列模型（55 页）
- `LLM能力` — LLM 上下文、提示工程与模型能力（53 页）
- `强化学习` — 强化学习、博弈论与决策（46 页）
- `文档处理` — 文档解析、OCR 与信息提取（46 页）
- `Lua编程` — Lua 脚本语言与游戏脚本（38 页）
- `AI设计` — AI 设计、前端 AI 应用（37 页）
- `矩阵理论` — 线性代数、矩阵分析（36 页）
- `深度学习` — 神经网络架构与训练（26 页）
- `控制论` — 控制系统、反馈机制（22 页）
- `C++编程` — C++ 编程模式与系统（14 页）
- `其他` — 小型 cluster 合并（273 页）
