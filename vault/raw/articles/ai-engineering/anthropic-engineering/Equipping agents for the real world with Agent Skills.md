...
Agent Skills are [supported today](https://www.anthropic.com/news/skills) across [Claude.ai](http://claude.ai/redirect/website.v1.2fdada8b-1f00-4d7f-aae1-42e8edc99723), Claude Code, the Claude Agent SDK, and the Claude Developer Platform.
