...
complexity(empirically). OurexperimentstestPPOonacollectionofbenchmarktasks,includ-
...
Thispaperseekstoimprovethecurrentstateofaffairsbyintroducinganalgorithmthatattains
...
betterthanthealgorithmswecompareagainst. OnAtari, itperformssignificantlybetter(interms
...
OpenAIGym[Bro+16]anddescribedbyDuanetal. [Dua+16].
1
7102
guA
82
...
form
|     |     |     |     |     | gˆ=E | ˆ   | logπ (a | s )Aˆ |     | (1) |
| --- | --- | --- | --- | --- | ---- | --- | ------- | ----- | --- | --- |
|     |     |     |     |     |      | t θ | θ       | t t t |     |     |
|     |     |     |     |     |      | ∇   |         | |     |     |     |
|     |     |     |     |     |      | h   |         | i     |     |     |
Aˆ
where π is a stochastic policy and is an estimator of the advantage function at timestep t.
|     | θ   |     |     |     | t   |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
ˆ
Here, the expectation E t [...] indicates the empirical average over a finite batch of samples, in an
algorithmthatalternatesbetweensamplingandoptimization. Implementationsthatuseautomatic
differentiation software work by constructing an objective function whose gradient is the policy
gradient estimator; the estimator gˆ is obtained by differentiating the objective
|     |     |     |     | LPG(θ)=E |     | ˆ   |           | )Aˆ       |     |     |
| --- | --- | --- | --- | -------- | --- | --- | --------- | --------- | --- | --- |
|     |     |     |     |          |     | t   | logπ θ (a | t s t t . |     | (2) |
|
|     |     |     |     |     |     |     | h   | i   |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
|            |        |      |          |        |         | (cid:20)      | |      | (cid:21) |     |     |
ˆ
|     |     |     | subject |     | to E | t [KL[π | θold ( | s t ),π θ ( s t )]] | δ.  | (4) |
| --- | --- | --- | ------- | --- | ---- | ------- | ------ | ------------------- | --- | --- |
|     |     |     |         |     |      |         | ·|     | ·| ≤                |     |     |
Here, θ is the vector of policy parameters before the update. This problem can efficiently be
old
...
|         |                   |      |              |          | π (a  | s )     |         |                |            |     |
|         |                   |      |              | ˆ        | θ t   | t Aˆ    |         |                |            |     |
|         |                   | maxi | mizeE        | t        |       | |       | t βKL[π | θold ( s t ),π | θ ( s t )] | (5) |
|         |                   |      | θ            | π        | (a    | s )     | −       | ·|             | ·|         |     |
|         |                   |      |              | (cid:20) | θo ld | t t     |         |                | (cid:21)   |     |
|
forsomecoefficientβ. Thisfollowsfromthefactthatacertainsurrogateobjective(whichcomputes
...
problem,wherethethecharacteristicschangeoverthecourseoflearning. Hence,toachieveourgoal
...
| --------- | --- | --------- | --- | --- | --------- | --- | ------- | --- | --- | --- |
|           |     |           |     |     |           | π   | ( a s ) |     |     |     |
Let r t (θ) denote the probability ratio r t (θ) = θ t | t , so r(θ old ) = 1. TRPO maximizes a
|             |           |     |           |     |          | πθ     | ( at s t)  |         |     |     |
| ----------- | --------- | --- | --------- | --- | -------- | ------ | ---------- | ------- | --- | --- |
|             |           |     |           |     |          |        | o l d |    |         |     |     |
| “surrogate” | objective |     |           |     |          |        |            |         |     |     |
|             |           |     |           |     |          | π (a s | )          |         |     |     |
|             |           |     | LCPI(θ)=E |     | ˆ        | θ t t  | Aˆ ˆ       | (θ)Aˆ   |     |     |
|             |           |     |           |     | t        | |      | t =E       | t r t t | .   | (6) |
|             |           |     |           |     | π        | (a s   | )          |         |     |     |
|             |           |     |           |     | (cid:20) | θold t | t (cid:21) |         |     |     |
|             |           |     |           |     |          | |      |            | h       | i   |     |
...
| move r | (θ) away | from | 1.  |     |     |     |     |     |     |     |
| ------ | -------- | ---- | --- | --- | --- | --- | --- | --- | --- | --- |
t
| The | main | objective | we propose |     | is the following: |     |     |     |     |     |
| --- | ---- | --------- | ---------- | --- | ----------------- | --- | --- | --- | --- | --- |
LCLIP(θ)=E ˆ min(r (θ)Aˆ ,clip(r (θ),1 (cid:15),1+(cid:15))Aˆ ) (7)
|     |     |     |     |     | t   | t t | t   |     | t   |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
−
|     |     |     |     |     | h   |     |     |     | i   |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
whereepsilonisahyperparameter, say, (cid:15)=0.2. Themotivationforthisobjectiveisasfollows. The
(cid:15),1+(cid:15))Aˆ
firstterminsidetheminisLCPI. Thesecondterm, clip(r (θ),1 , modifiesthesurrogate
|     |     |     |     |     |     |     | t   | −   | t   |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
objective by clipping the probability ratio, which removes the incentive for moving r t outside of the
interval [1 (cid:15),1+(cid:15)]. Finally, we take the minimum of the clipped and unclipped objective, so the
−
...
around θ (i.e., where r =1), however, they become different as θ moves away from θ . Figure 1
old old
plots a single term (i.e., a single t) in LCLIP; note that the probability ratio r is clipped at 1 (cid:15)
−
| or 1+(cid:15) | depending |     | on whether | the | advantage | is positive | or negative. |     |     |     |
| ------------- | --------- | --- | ---------- | --- | --------- | ----------- | ------------ | --- | --- | --- |
A<0
A>0
LCLIP
...
theprobabilityratior,forpositiveadvantages(left)andnegativeadvantages(right). Theredcircleoneach
LCLIP
plot shows the starting point for the optimization, i.e., r=1. Note that sums many of these terms.
Figure2providesanothersourceofintuitionaboutthesurrogateobjectiveLCLIP.
Itshowshow
...
Figure 2: Surrogate objectives, as we interpolate between the initial policy parameter θ , and the updated
old
policyparameter,whichwecomputeafteroneiterationofPPO.TheupdatedpolicyhasaKLdivergenceof
...
achieve some target value of the KL divergence d each policy update. In our experiments, we
targ
...
|     |     |     |             |     |          | π (a | s )     |         |            |     |
| --- | --- | --- | ----------- | --- | -------- | ---- | ------- | ------- | ---------- | --- |
|     |     |     | LKLPEN(θ)=E |     | ˆ        | θ    | t t Aˆ  |         |            |     |
|     |     |     |             |     |          |      | | βKL[π | ( s     | ),π ( s )] | (8) |
|     |     |     |             |     | t        | π (a | s ) t − | θold ·| | t θ ·| t   |     |
|     |     |     |             |     |          | θold | t t     |         |            |     |
|     |     |     |             |     | (cid:20) |      | |       |         | (cid:21)   |     |
ˆ
|     | Compute |          | d=E t [KL[π | θold   | ( s t ),π | θ ( s | t )]] |     |     |     |
| --- | ------- | -------- | ----------- | ------ | --------- | ----- | ----- | --- | --- | --- |
|     | •       |          |             |        | ·|        | ·|    |       |     |     |     |
|     |         | – If d<d | /1.5,       | β      | β/2       |       |       |     |     |     |
|     |         |          | targ        | ←      |           |       |       |     |     |     |
...
updates where the KL divergence is significantly different from d targ , however, these are rare, and
...
finite-horizonestimatorsin[Mni+16]. Ifusinganeuralnetworkarchitecturethatsharesparameters
...
each iteration:
|     |     | LC  | LIP+VF+S(θ)=E |     | ˆ   | LC LIP(θ) |     | LV  | F(θ)+c |                   |     |     |
| --- | --- | --- | ------------- | --- | --- | --------- | --- | --- | ------ | ----------------- | --- | --- |
|     |     |     |               |     | t   |           |     | c 1 |        | 2 S[π θ ](s t ) , |     | (9) |
|     |     |     | t             |     |     | t         | −   | t   |        |                   |     |     |
where c ,c are coefficients, and S deno(cid:2)tes an entropy bonus, and LVF is(cid:3)a squared-error loss
|     | 1 2 |     |     |     |     |     |     |     |     | t   |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
targ )2.
| (V θ (s | t ) V |     |     |     |     |     |     |     |     |     |     |     |
...
|     |     | Aˆ  | = V(s | )+r | +γr | +   | +γT | t+1r | +γT | tV(s ) |     | (10) |
| --- | --- | --- | ----- | --- | --- | --- | --- | ---- | --- | ------ | --- | ---- |
|     |     |     | t     | t   | t   | t+1 |     | −    | T 1 | − T    |     |      |
|     |     |     | −     |     |     |     | ··· |      | −   |        |     |      |
...
| -------- | --------- | ---- | ----- | ----------- | ------------ | --- | ----- | ------ | ---- | ----- | --- | ---- |
|          |           |      | Aˆ    |             |              |     |       | +(γλ)T | t+1δ |       |     |      |
|          |           |      | t     | =δ t +(γλ)δ | t+1          | +   | +     |        | −    | T 1 , |     | (11) |
|          |           |      |       |             |              | ··· | ···   |        |      | −     |     |      |
|          |           |      | where | δ           | t =r t +γV(s |     | t+1 ) | V(s t  | )    |       |     | (12) |
−
...
|             | for actor=1,2,...,N |     |              | do          |       |          |           |           |     |     |     |     |
|             | Run policy          |     | π in         | environment |       | for T    | timesteps |           |     |     |     |     |
θold
|     |         |           |     |           | Aˆ  | ,...,Aˆ |     |     |     |     |     |     |
| --- | ------- | --------- | --- | --------- | --- | ------- | --- | --- | --- | --- | --- | --- |
|     | Compute | advantage |     | estimates |     | 1       | T   |     |     |     |     |     |
|     | end for |           |     |           |     |         |     |     |     |     |     |     |
...
LCLIP
compare the surrogate objective to several natural variations and ablated versions.
(θ)Aˆ
|     | No clipping | or  | penalty: |     |     | L (θ)=r |     |     |     |     |     |     |
| --- | ----------- | --- | -------- | --- | --- | ------- | --- | --- | --- | --- | --- | --- |
|     |             |     |          |     |     | t       | t   | t   |     |     |     |     |
Clipping: L (θ)=min(r (θ)Aˆ ,clip(r (θ)),1 (cid:15),1+(cid:15))Aˆ
|     |     |     |     |     |     | t   |     | t   | t   | t   | t   |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
−
(θ)Aˆ
|     | KL penalty | (fixed | or  | adaptive) |     | L (θ)=r |     |     | βKL[π | ,π ]   |     |     |
| --- | ---------- | ------ | --- | --------- | --- | ------- | --- | --- | ----- | ------ | --- | --- |
|     |            |        |     |           |     | t       | t   | t   | −     | θold θ |     |     |
5

For the KL penalty, one can either use a fixed penalty coefficient β or an adaptive coefficient as
described in Section 4 using target KL value d . Note that we also tried clipping in log space,
targ
...
one million timesteps of training on each one. Besides the hyperparameters used for clipping ((cid:15))
and the KL penalty (β,d ), which we search over, the other hyperparameters are provided in in
targ
Table 3.
...
deviations, following[Sch+15b; Dua+16]. Wedon’tshareparametersbetweenthepolicyandvalue
function (so coefficient c 1 is irrelevant), and we don’t use an entropy bonus.
...
TheresultsareshowninTable1. Notethatthescoreisnegativeforthesettingwithoutclipping
...
|            |             | Clipping, | (cid:15)=0.1        |                 | 0.76  |
|            |             | Clipping, | (cid:15)=0.2        |                 | 0.82  |
|            |             | Clipping, | (cid:15)=0.3        |                 | 0.70  |
|            |             | Adaptive  | KL d =0.003         |                 | 0.68  |
targ
|     |     | Adaptive | KL d targ =0.01 |     | 0.74 |
| --- | --- | -------- | --------------- | --- | ---- |
|     |     | Adaptive | KL d =0.03      |     | 0.71 |
targ
|     |     | Fixed | KL, β =0.3 |     | 0.62 |
| --- | --- | ----- | ---------- | --- | ---- |
|     |     | Fixed | KL, β =1.  |     | 0.71 |
...
methodsfromtheliterature, whichareconsideredtobeeffectiveforcontinuousproblems. Wecom-
...
2HalfCheetah,Hopper,InvertedDoublePendulum,InvertedPendulum,Reacher,Swimmer,andWalker2d,all“-v1”
3Aftereachbatchofdata,theAdamstepsizeisadjustedbasedontheKLdivergenceoftheoriginalandupdated
...
(cid:15) = 0.2. We see that PPO outperforms the previous methods on almost all the continuous control
environments.
...
off the ground, possibly while being pelted by cubes. The three tasks we test on are (1) Ro-
...
FlagrunHarder, wheretherobotispeltedbycubesandneedstogetupofftheground. SeeFigure5
...
Table2: Numberofgames“won”byeachalgorithm,wherethescoringmetricisaveragedacrossthreetrials.
7 Conclusion
Wehaveintroducedproximalpolicyoptimization, afamilyofpolicyoptimizationmethodsthatuse
...
onlyfewlinesofcodechangetoavanillapolicygradientimplementation,applicableinmoregeneral
...
M.Riedmiller,A.K.Fidjeland,G.Ostrovski,etal.“Human-levelcontrolthroughdeep
...
| -------- | ---------------- | --- | --- | ------- | --- | --- | --- |
[Sch+15a] J.Schulman,P.Moritz,S.Levine,M.Jordan,andP.Abbeel.“High-dimensionalcontin-
uouscontrolusinggeneralizedadvantageestimation”.In:arXivpreprintarXiv:1506.02438
(2015).
...
“SampleEfficientActor-CriticwithExperienceReplay”.In:arXivpreprintarXiv:1611.01224
(2016).
...
− −
Table4: PPOhyperparametersusedfortheRoboschoolexperiments. Adamstepsizewasadjustedbasedon
...
|     |     |     | GAE parameter | (λ)       | 0.95           |     |
|     |     |     | Number        | of actors | 8              |     |
|     |     |     | Clipping      | parameter | (cid:15) 0.1 α |     |
×
|     |     |     | VF coeff. | c (9) | 1   |     |
| --- | --- | --- | --------- | ----- | --- | --- |
1
...
| --- | --- | --- | ------- | ---------- | -------- | --- |
Table5: PPOhyperparametersusedinAtariexperiments. αislinearlyannealedfrom1to0overthecourse
of learning.
| B Performance |     | on  | More | Atari | Games |     |
| ------------- | --- | --- | ---- | ----- | ----- | --- |
HereweincludeacomparisonofPPOagainstA2Conalargercollectionof49Atarigames. Figure6
showsthelearningcurvesofeachofthreerandomseeds,whileTable6showsthemeanperformance.
10
...
| 3000000 |          | 1000 |           |       |            |           | 50  |         |
|         |          |      |           | 15000 |            | 3000      |     |         |
| 2000000 |          |      |           | 10000 |            | 2000      | 40  |         |
500
| 1000000 |        |     |          | 5000 |           | 1000           | 30  |              |
| ------- | ------ | --- | -------- | ---- | --------- | -------------- | --- | ------------ |
| 0       |        | 0   |          |      |           |                |     |              |
...
|     |            | 0   |        | 2   |           | 0         |        |         |
| --- | ---------- | --- | ------ | --- | --------- | --------- | ------ | ------- |
|     | StarGunner |     | Tennis |     | TimePilot | Tutankham | 200000 | UpNDown |
300
| 40000 |     | 10  |     |      |     |     |        |     |
| ----- | --- | --- | --- | ---- | --- | --- | ------ | --- |
|       |     |     |     | 4000 |     | 200 |        |     |
...
Table6: Meanfinalscores(last100episodes)ofPPOandA2ConAtarigamesafter40Mgameframes(10M
timesteps).
12