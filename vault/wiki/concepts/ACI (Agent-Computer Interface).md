...
source_count: 2
tags: [agent-design, interface, tool-design, engineering-principle, AI工程]
...
## 概述
[[ACI 设计原则|Agent-Computer Interface 设计原则]]，强调工具定义需要与 prompt 工程同等重视，是 [[Anthropic]] 提出的核心工程洞见之一。

## 关键内容
1. **核心洞见**：将 ACI 与 HCI（Human-Computer Interface）进行类比——"思考投入到人机界面中的工作量，并计划投入同等工作量来创建良好的 Agent-[[计算]]机接口。"
