...
Shannon-Hartley 公式是 Shannon (1949) 给出的连续[[信道容量]]公式：C = W log₂(1 + S/N)，精确量化了带宽 W、[[信噪比]] S/N 与可靠传输速率上限之间的关系，是通信工程的"万有引力公式"。
...
1. **信号分辨率**：[[信噪比]] S/N 决定了可区分的信号电平数，约 √(1 + S/N) 个。每秒 2W 个独立样本，每个样本 log₂ √(1 + S/N) bit，总计 W · log₂(1 + S/N)
