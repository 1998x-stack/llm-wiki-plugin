...
**历史备注**：切比雪夫在 1854 年给出了"最佳逼近$\Rightarrow$等振荡"的必要性论证；"等振荡$\Rightarrow$最佳逼近"的充分性由 Borel（1905）或 Kirchbe[[ripgrep|rg]]er（1902）严格证明。
...
| Clenshaw-Curtis 求积 | 1960年，使用切比雪夫极值点为节点，可借助 [[快速傅里叶变换|FFT]] 计算权重 |
