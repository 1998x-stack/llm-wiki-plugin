...
- **P**（Polynomial time）：所有可以被确定性图灵机在多项式时间内求解的判定问题的集合
- **NP**（Non-deterministic Polynomial time）：所有可以被非确定性图灵机在多项式时间内求解的判定问题的集合
...
- 如果任何一个 NP 完全问题有多项式算法，则 P = NP
- 如果任何一个 NP 完全问题没有多项式算法，则 P ≠ NP
