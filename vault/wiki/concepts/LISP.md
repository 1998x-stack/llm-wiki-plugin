...
LISP（LISt Processor）是世界上第二古老的高级编程语言（仅次于 FORTRAN），由 John McCarthy 于1958-1960年设计，基于 λ 演算，开创了函数式编程范式。
...
- 函数式编程的源头，影响了 JavaScript、Python、Ruby 等现代语言
- 同像性催生了宏系统，使 LISP 在元编程领域无可匹敌
