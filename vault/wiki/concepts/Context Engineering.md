...
## 概述
多步骤系统中信息流的全局架构设计方法论，与[[Prompt-Engineering|提示词工程]]（单次调用措辞优化）本质不同，关注如何为每个[[Subagents-in-Claude-Code|子智能体]]提供干净、充足、精准的上下文。

## 关键内容

1. **与[[Prompt-Engineering|提示词工程]]的区别**：
   - **[[Prompt-Engineering|提示词工程]]**：关注单次调用的措辞优化
