...
7. **历史影响**：2009年发表后成为[[隐式反馈]]推荐的标准[[规范化理论|范式]]，BPR Loss 至今仍是 [[LightGCN]]、[[NeuMF]]、[[DeepFM]] 等模型的核心训练目标，6000+ 引用量。BPR 论文在 Rossmann 和 [[Netflix]] 数据集上的实验表明，BPR-MF 在不同隐向量维度下均显著优于 SVD-MF 和 [[WR-MF]]，验证了优化准则的重要性。
