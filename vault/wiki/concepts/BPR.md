...
4. **LearnBPR 算法**：采用 bootstrap 随机采样三元组 (u, i, j) 的 SGD 算法，相比按用户遍历的梯度下降收敛更快、随时可停、梯度估计更均匀。
...
7. **历史影响**：2009年发表后成为[[隐式反馈]]推荐的标准[[规范化理论|范式]]，BPR Loss 至今仍是 [[LightGCN]]、[[NeuMF]]、[[DeepFM]] 等模型的核心训练目标，6000+ 引用量。
