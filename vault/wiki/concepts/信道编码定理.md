...
信道编码定理（[[channel|Channel]] Coding Theorem）是 Shannon (1948) 的第二定理：对于传输速率 R < [[信道容量]] C，存在编码方案使得解码错误概率任意小；对于 R > C，不存在任何编码方案能使错误概率趋于零。
...
1. **存在性而非构造性**：Shannon 证明了可靠通信方案的存在，但没有给出具体的编码[[算法]]
