...
## 概述
[[Hermes Agent]] 在长对话自然暂停点主动自我反思的机制，检查是否有值得保存的经验、偏好或[[Skills|技能]]，确保信息不流失。
...
- **自我反思清单**：
  ...
  - 发现了现有[[Skills|技能]]的问题吗？→ 更新 [[SKILL.md 格式规范|SKILL.md]]
...
- **与闭环学习的关系**：Nudge 是[[闭环学习系统]]的驱动引擎——每次 Nudge 都可能触发记忆更新、[[Skills|技能]]创建或[[Skills|技能]]改进，推动学习飞轮持续运转
