...
## 概述
Raft算法是2014年由Diego Ongaro和John Ousterhout提出的分布式共识算法，明确以"可理解性"为首要设计目标，是Paxos算法的替代方案。Raft在理论能力上与Multi-Paxos等价，但通过更好的分解和简化大幅降低了理解和实现的难度。
