...
## 概述
N-BEATS（Neural Basis Expansion Analysis for Interpretable Time Series Forecasting）由 Boris Oreshkin 等（[[Yoshua Bengio]] 团队）于 2019 年提出，用纯全连接网络在 M4 竞赛中击败了所有统计方法，证明深度学习可独立称霸[[Time Series Analysis|时间序列]]预测。
