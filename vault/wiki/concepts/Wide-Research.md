...
Wide Research（广泛研究）是 [[Manus]] 推出的架构[[规范化理论|范式]]，通过并行启动多个专用子代理来解决[[上下文窗口]]限制导致的"编造阈值"问题。每个子代理都是功能齐全的 [[Manus]] 实例，独立处理研究子任务，最后汇总为综合结论。（[[Manus]] 于 2026 年被 Meta 收购）
