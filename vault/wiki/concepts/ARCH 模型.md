...
## 概述
ARCH（[[AR 模型（自回归模型）|自回归]][[Conditional Heteroskedasticity|条件异方差]]）模型由 [[Robert Engle]] 于 1982 年提出，首次为金融市场波动率的时变特征提供数学框架，揭示了"[[Volatility Clustering|波动率聚集]]"现象，是金融计量经济学的里程碑，Engle 因此获得 2003 年诺贝尔经济学奖。
...
3. **[[Volatility Clustering|波动率聚集]]**：Engle 用河流类比——河水汹涌时不会立刻恢复平静，而是持续翻滚一段时间。金融市场同理，一次剧烈震荡后市场不会立刻风平浪静。
