...
[[Codex CLI]] 的并行任务执行系统，让 [[Codex CLI|Codex]] 从"单线程 AI 程序员"变成"AI 开发团队调度中心"。主 Agent 将复杂[[任务分解]]后，派遣多个[[子 Agent & 多 Agent 系统|子 Agent]] 并行执行，收集汇总结果。
...
2. 每个 [[Worker Agent]] 独立上下文、独立[[Claude Code 沙箱机制|沙箱]]
