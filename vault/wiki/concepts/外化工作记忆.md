...
人类在面对复杂问题时，也需要"写下来"帮助思考——清单、草稿纸、白板。这种将内部思维过程外部化的行为，在认知科学中被称为**外化工作记忆**。
...
外化工作记忆机制揭示了 LLM 执行复杂工具调用链时的深层需求：
- LLM 不仅需要工具来**访问外部信息**
...
2. 外化工作记忆的质量直接影响模型在复杂场景中的表现
3. 可以通过 prompt 示例引导模型更有效地使用外化工作记忆
