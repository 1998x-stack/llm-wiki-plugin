...
## 概述
DQN（Deep Q-Network）是 [[DeepMind]] 于 2013/2015 年发表的深度[[强化学习]]奠基算法，将[[卷积神经网络（CNN）|卷积神经网络]]与 Q-learning 结合，通过[[经验回放]]和[[目标网络]]两项工程创新，首次在 Atari 2600 游戏上从原始像素端到端学习超人类策略，开启深度[[强化学习]]的黄金十年。
...
7. **工程遗产**：确立的[[规范化理论|范式]]（深度网络函数逼近 + 经验[[经验回放|回放缓冲区]] + [[目标网络]] + ε-greedy + 奖励归一化）被几乎所有后续 off-policy 深度 RL 算法继承。
