...
## 概述
神经[[矩阵分解]]，NCF 框架的最终融合模型，将 GMF 的线性建模能力与 MLP 的非线性建模能力结合，通过独立嵌入空间和后融合策略实现互补。
...
6. **后续争议**：[[Steffen Rendle]]等人（2020）指出，精心调优的 MF 可以达到与 NeuMF 相当甚至更好的效果，质疑 NeuMF 的优势是否来自训练策略差异而非模型架构本身。
