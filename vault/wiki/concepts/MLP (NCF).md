...
## 概述
[[神经协同过滤]](NCF)框架中的[[多层感知机]]模型，专门用于学习用户-物品交互中的非线性模式。
...
3. **与GMF对比**：MLP从零开始自由探索交互模式空间，而GMF像是在已知"交互应该是乘法形式"的前提下做精细调整，MLP在多数实验[[Settings|设置]]下性能优于GMF。
