...
## 概述
微软于 [[KDD|KDD 2018]] 提出的 [[CTR 预估]]模型，引入 CIN（Compressed Interaction Network）在向量级显式建模任意阶[[特征交叉|特征交互]]，解决 [[DeepFM]] FM 组件仅二阶交叉的局限。
...
4. **[[KDD|KDD 2018]]**：论文 "x[[DeepFM]]: Combining Explicit and Implicit [[特征交叉|Feature Interaction]]s for Recommender Systems" 发表于 [[KDD|KDD 2018]]。
