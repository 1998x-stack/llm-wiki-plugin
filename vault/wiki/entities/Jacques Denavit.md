...
### 1. 学术背景与合作
1955 年，Jacques Denavit 任职于美国**Northwestern University**（西北大学）。当时，机构学领域缺乏统一的运动学描述符号，不同的研究者使用各异的坐标约定，导致成果难以比较和复用。Denavit 敏锐地捕捉到了矩阵代数在工程计算中的潜力，并与同事 Richard S. Hartenberg 展开了深入合作。
