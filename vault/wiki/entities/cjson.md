...
## 关键内容
1. **在 [[UrhoX引擎|UrhoX]] 中的推荐**：JSON 编解码推荐使用 cjson，相关文档见 `engine-docs/recipes/json.md`。
2. **性能优势**：cjson 是 C 扩展库，编解码速度远快于纯 Lua 实现，适合游戏[[Configuration|配置]]加载、存档读写等场景。
