...
6. **实验结果**：在 RSC15（YOOCHOOSE）数据集上，[[候选生成|Recall]]@20 达 0.5196，[[MRR]]@20 达 0.2164，相比 [[基于物品的协同过滤|Item-KNN]] 提升约 20-30%。后续 [[生成式推荐|GR]]U4Rec v2（CIKM 2018）提出 [[BPR]]-max 和 [[TOP1 Loss|TOP1]]-max，性能再提升 35%。
