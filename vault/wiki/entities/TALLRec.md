...
2. **技术方法**：使用[[指令调优]]使 LLaMA 适配推荐场景，将推荐任务转化为自然语言指令格式，通过 Lo[[rust-analyzer|RA]] 等参数高效微调方法进行训练。

3. **与 [[P5 论文|P5]] 的关系**：借鉴了 [[P5 论文]] 的任务统一思想，但用 LLaMA 替代 [[T5]] 作为骨干模型，用[[指令调优]]替代 Prompt 模板，代表了从 [[P5 论文|P5]] 到现代 LLM 推荐的关键演进。
