...
## 概述
[[Netflix]] 2006-2009 年举办的推荐[[算法]]竞赛，100 万美元奖金推动[[矩阵分解]]技术崛起，彻底改变了推荐系统领域的发展轨迹。
...
5. **历史影响**：竞赛确立了[[矩阵分解]]作为推荐系统第一[[规范化理论|范式]]的地位，其产生的技术洞察被 [[Spotify]]、[[Amazon]]、[[YouTube]] 等工业界广泛采用。
