...
4. **实验验证**：使用 [[MovieLens]] 100K 数据集（943 用户、1,682 部电影、100,000 条评分），以[[平均绝对误差 MAE|平均绝对误差]]（MAE）为评估指标，证明 [[基于物品的协同过滤|Item-Based CF]] 在推荐质量和性能上均优于 [[基于用户的协同过滤|User-Based CF]]。
