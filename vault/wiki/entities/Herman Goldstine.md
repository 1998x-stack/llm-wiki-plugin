...
- target: "[[约翰·冯·诺依曼]]"
  type: related_to
  confidence: 0.85
  note: ENIAC 项目的军方联络官和安全官员
- target: "[[冯·诺依曼稳定性分析]]"
  type: extends
  confidence: 0.8
  note: 与 von Neumann 在数值分析方面深入合作
supersedes: null
---
...
- Goldstine 在分发报告时仅列出了 von Neumann 的名字，且 von Neumann 本人从未公开澄清其他贡献者的角色
- 这一事件不仅造成了个人之间的深刻裂痕，也导致了 EDVAC 专利的失效
