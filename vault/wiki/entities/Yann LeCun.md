...
## 概述 (50-200字符)
Yann LeCun（杨立昆），法国计算机科学家，深度学习三巨头之一，[[卷积神经网络（CNN）|卷积神经网络]]之父，2018 年[[阿兰·图灵|图灵]]奖得主，现任 Meta 首席 AI 科学家。

## 关键内容 (≥300字符, 用[[双链]])
1. **[[LeNet-5]] 与 CNN 的奠基**：1990 年代在[[贝尔实验室]]工作期间，LeCun 针对美国邮政局（USPS）手写邮编识别难题，构建了端到端图像识别系统。1998 年发表 [[Gradient-Based Learning Applied to Document Recognition (1998 论文)]]，提出 [[LeNet-5]] 架构，确立了 [[卷积神经网络（CNN）]] 的完整框架——局部感受野、权重共享、池化层、端到端 [[反向传播]] 训练。这一工作证明了特征可以被自动学习，从此人工特征工程不再是图像识别的瓶颈。
