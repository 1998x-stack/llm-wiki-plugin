...
美国计算机科学家（1927–2011），LISP 编程语言发明者，1956年达特茅斯会议上正式提出"人工智能"术语。1971年因 AI 领域开创性贡献获得 ACM 图灵奖。

## 关键内容

### LISP（1960）

- 基于 Church 的 λ 演算设计了 LISP 语言
- 引入了递归函数、条件表达式、垃圾回收和"代码即数据"等革命性概念
...
- 与会者包括 Minsky、Shannon、Simon 等日后的领军人物
