...
1. **[[FunkSVD]] 的诞生**：2006 年 12 月，在 [[Netflix Prize]] 竞赛开始仅两个月后，Simon Funk 以个人博客形式发表了一篇里程碑式文章，描述了基于随机梯度下降（SGD）的[[矩阵分解]]方法。该方法放弃了对完整[[矩阵]]做精确 SVD 分解的传统思路，转而仅在已知评分上进行梯度优化。
