...
1. **里程碑论文**：作为第三作者参与了 [[Deep Neural Networks for YouTube Recommendations]]（RecSys 2016）的研究和撰写。该论文确立了工业推荐系统的"[[候选生成]] + 排序"两阶段架构范式。
...
## 相关
- [[Deep Neural Networks for YouTube Recommendations]] — 第三作者的里程碑论文
