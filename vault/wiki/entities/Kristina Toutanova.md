...
aliases: ["Kristina Toutanova", "Toutanova"]
relates_to:
...
作为第四作者与 [[Jacob Devlin]]、[[Ming-Wei Chang]]、[[Kenton Lee]] 共同发表了《[[BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding (2019 论文)|BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding]]》（NAACL 2019），提出了 [[掩码语言模型（MLM）]] 和 [[下一句预测（NSP）]] 两大预训练任务。
...
- [[BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding (2019 论文)]] — 第四作者
- [[BERT]] — BERT 模型合作作者
