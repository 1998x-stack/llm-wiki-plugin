...
## 概述
MovieLens 是从 [[GroupLens|GroupLens 研究组]]于 1997 年直接孵化出的在线电影推荐平台，同时产出了推荐系统领域最重要的公开数据集，从 MovieLens 100K 到 MovieLens 25M，每年被下载数十万次，是全球推荐[[算法]]研究的标准基准。

## 关键内容

1. **起源**：1997 年从 [[GroupLens]] 研究组直接孵化，是一个面向公众的在线电影推荐平台。其初衷不仅提供[[服务]]，更是为了收集大规模用户评分数据以推动推荐系统研究。
...
3. **学术影响**：过去三十年中绝大多数[[协同过滤]][[算法]]论文都直接或间接使用了 MovieLens 数据集。它提供了一个标准化的比较平台，使得不同研究团队可以在相同数据上评估[[算法]]性能。
