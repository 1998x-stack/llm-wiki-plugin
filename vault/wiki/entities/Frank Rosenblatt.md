...
## 概述
Frank Rosenblatt（1928–1971），美国心理学家，康奈尔大学教授，于 1958 年提出[[感知机]]模型并搭建世界第一台可学习机器 [[Mark I Perceptron]]，是人工神经网络和深度学习的直接先驱。
...
3. **[[感知机学习规则]]**：提出权重通过错误自动修正的[[算法]]——错了就改，对了维持不动。这是[[感知机]]最革命性的贡献，证明了机器可以从经验中学习。

4. **收敛定理**：严格证明了若训练数据线性可分，[[感知机]]学习[[算法]]在有限步内必然收敛，为机器学习提供了首个严格的理论保证。
