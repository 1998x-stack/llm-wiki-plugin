...
SWE-agent 是由 Princeton 团队（2024）开发的 AI Agent 系统，能将 LLM 转化为软件工程师，自动修复 GitHub 仓库中的真实 issue 和 bug。通过专门设计的 Agent 计算机接口（[[Agent计算机接口|ACI]]）和 [[ReAct 风格循环]]，在 [[SWE-bench]] 上取得显著优于直接输出 patch 的效果。
