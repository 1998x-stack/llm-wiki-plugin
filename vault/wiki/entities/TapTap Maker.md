...
## 概述
TapTap 旗下的 AI 原生游戏开发工具（TTM），专为 AI 设计的游戏引擎，支持组件化开发、[[Skills|技能]]库系统，已支持 30 万行中型游戏，具备开发-发布全闭环能力。

## 关键内容

1. **[[AI 原生架构]]**：GUI 不适合 AI，优先为 Agent 设计架构，面向「Agent + 人」双端。给 AI 灌[[Skills|技能]]（游戏品类开发流程的抽象理解），而非灌知识或堆 Demo。

2. **[[Skills|技能]]库系统**：重质不重量，不乱加[[Skills|技能]]以保证不降低 Agent 性能，优先做组件化。
