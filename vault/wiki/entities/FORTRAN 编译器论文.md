...
[[John Backus]] 等人于1957年发表的《The [[FORTRAN]] [[Automatic Coding|Automatic Coding System]]》，是编程语言史上第一篇系统描述高级语言编译器设计的论文，证明了编译生成的代码效率可达手写汇编的90%以上。
...
| 项目 | 内容 |
|------|------|
| **标题** | The [[FORTRAN]] [[Automatic Coding|Automatic Coding System]] |
...
2. **公共子表达式消除** — 识别重复[[计算]]的子表达式
3. **循环分析** — 识别循环结构，确定嵌套深度
4. **寄存器分配** — 智能分配 [[IBM 704]] 的三个索引寄存器
5. **指令合并与优化** — 强度削减、利用特殊指令格式
6. **最终[[代码生成]]与组装** — 生成可执行目标代码

### 性能数据

[[FORTRAN]] 生成的代码效率通常达到手写汇编的 90% 以上，在某些以循环为主的科学[[计算]]程序中甚至优于普通程序员的手写汇编。
